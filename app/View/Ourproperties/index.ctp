...
$(".inlinefancy").fancybox({
	...
	<header id="head" class="secondary">
		<div class="container">
			<div class="row">
				<div class="col-sm-8">
					<h1><?php echo __('Properties of');?> <?php echo$projectName;?></h1>
				</div>
			</div>
		</div>
	</header>
...
<div class="mrg-top"><?php echo$this->Html->link('<span class="fa fa-arrow-left"></span> '.__('Back'),'#',array('class'=>'btn btn-info','escape'=>false,'onclick'=>'history.back(-1);'));?></div>
...
<?php echo $this->Session->flash();?>
	...
	if($post['PropertiesDocument'])
	{
		...
		endforeach;
		$layoutImage=$this->Html->link(__('Properties Document'),"/$photoImg",array('rel'=>$post['Ourproperty']['name'].'PropertiesDocument','class'=>'fancybox btn btn-primary btn-xs','escape'=>false)).$extraPhoto;
	}
	else
	{
		$layoutImage=$this->Form->button(__('No Properties Document'),array('class'=>'btn  btn-primary btn-xs','title'=>$post['Ourproperty']['name'],'escape'=>false));
	}
	...
	?>
			...
			<div class="col-md-12 mrg">
						...
						<div class="mrg-top"><?php echo$this->Html->link(__('Show Flats&nbsp;/&nbsp;Plots&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'),array('controller'=>'Ourflats','action'=>'index',$id),array('class'=>'inlinefancy btn  btn-success btn-sm','title'=>$post['Ourproperty']['name'],'escape'=>false));?></div>
						</div>	
						<div class="col-md-9 col-sm-8">
								<p><strong> <?php echo __('Property Name');?> :</strong>&nbsp;&nbsp;<font class="text-danger"><?php echo$post['Ourproperty']['name'];?></font></p>
								<p><strong> <?php echo __('Type');?> :</strong>&nbsp;&nbsp;<font class="text-danger"><?php echo$post['Ourproperty']['type'];?></font>&nbsp;&nbsp;<strong>For</strong>&nbsp;&nbsp;<font class="text-danger"><?php echo$post['Ourproperty']['availiable'];?></font></p>
								<p><strong> <?php echo __('Status');?> :</strong>&nbsp;&nbsp;<span class="label label-<?php if($post['Ourproperty']['status']=="Availiable")echo"success";else echo"danger";?>"><?php echo $post['Ourproperty']['status'];?></span></p>
								
								<div class="col-md-12 col-sm-12">
									<div class="col-md-3 col-sm-6 mrg-xs"><?php echo$this->Html->link(__('Description'),"#dinlinefancy$id",array('title'=>$post['Ourproperty']['name'],'class'=>'inlinefancy btn  btn-primary btn-sm','escape'=>false));?></div>
