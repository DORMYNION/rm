				...
				<div class="panel panel-default">					
						...
						<div class="table-responsive">
						  ...
						  <boody>
							...
							<?php echo$this->Html->image('logo-website.fw.png',array('alt'=>__('Rolftask'),'class'=>'img-responsive'));?>
						      </td>
						    </tr>
						    <tr>
						      <td colspan="2" align="center">
						    ...
						    <tr>
						      ...
						      <td align="center"><span class="text-danger"><strong><?php echo __('User');?> : ELF000000</strong></span></td>
						  </tr>
						    <tr>
