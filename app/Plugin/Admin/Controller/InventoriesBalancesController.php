    ...
    public function add($id=null)
    {
        ...
        if ($this->request->is('post'))
        {
            ...
            try
            {
                ...
                {
                    $this->Session->setFlash(__('Your Entry has been saved.'),'flash',array('alert'=>'success'));
     ...
     public function edit($id = null)
    {
        ...
        if ($this->request->is(array('post', 'put')))
        {
            ...
            try
            {
                ...
                {
                    $this->Session->setFlash(__('Your Entries has been saved.'),'flash',array('alert'=>'success'));
