...
class ProjectsLocationmapsController extends AdminAppController {
        ...
        if ($this->request->is('post'))
        {
            if ($this->request->is('post'))
            {
                ...
                try
                {
                    ...
                    $this->Session->setFlash(__('Location Map has been saved'),'flash',array('alert'=>'success'));
    ...
    public function deleteall()
    {
        if ($this->request->is('post'))
        {
            ...
            $this->Session->setFlash(__('Location Map has been deleted.'),'flash',array('alert'=>'success'));
            $projectId=$this->data['projectId'];
        }
