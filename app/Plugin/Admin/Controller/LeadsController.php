...
class LeadsController extends AdminAppController {
    ...
    public function add()
    {
        ...
        if ($this->request->is('post'))
        {
            ...
            try
            {
                ...
                {
                    $this->Session->setFlash(__('Your Lead has been saved.'),'flash',array('alert'=>'success'));
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(array('post', 'put')))
        {
            ...
            try
            {
                ...
                {
                    $this->Session->setFlash(__('Your Lead has been updated.'),'flash',array('alert'=>'success'));
    ...
    public function deleteall()
    {
        if ($this->request->is('post'))
        {
            ...
            $this->Session->setFlash(__('Your Lead has been deleted.'),'flash',array('alert'=>'success'));
        }        
