        ...
        if ($this->request->is('post'))
        {
            ...
            try
            {
                ...
                if ($this->Property->save($this->request->data))
                {
                    ...
                    $this->Session->setFlash(__('Property has been saved. Add Flats/Plots'),'flash',array('alert'=>'success'));
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(array('post', 'put')))
        {
            try
            {
                ...
                {
                    $this->Session->setFlash(__('Your Property has been updated.'),'flash',array('alert'=>'success'));
                    return $this->redirect(array('action' => 'index'));
                }                
            }
            catch (Exception $e)
    ...
    public function deleteall()
    {
        try
        {
            if ($this->request->is('post'))
            {
                ...
                $this->Session->setFlash(__('Your Property has been deleted.'),'flash',array('alert'=>'success'));
            }        
