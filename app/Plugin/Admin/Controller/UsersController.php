        ...
        if ($this->request->is('post'))
        {
			...
			if($this->emailNotification)
			{
				...
				/* End Email */
                    ...
                    $this->Session->setFlash(__('Your User has been saved.'),'flash',array('alert'=>'success'));
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(array('post', 'put')))
        {
            ...
            try
            {
                ...
                {
                    $this->Session->setFlash(__('Your User has been updated.'),'flash',array('alert'=>'success'));
                    return $this->redirect(array('action' => 'index'));
                }
            }
            catch (Exception $e)
   ...
   public function deleteall()
    {
        if ($this->request->is('post'))
        {
            ...
            $this->Session->setFlash(__('Your User has been deleted.'),'flash',array('alert'=>'success'));
        }        
        ...
        if ($this->request->is('post'))
        {
            ...
            try
            {
                ...
                if(preg_match($pattern, $string))
                {
                    ...
                    {
                        $this->Session->setFlash(__('Your Level User has been saved.'),'flash',array('alert'=>'success'));
                        return $this->redirect(array('action' => 'assignrights'));
                    }
                }
                else
                {
                    $this->Session->setFlash(__('Invalid Level Name'),'flash',array('alert'=>'danger'));
                    return $this->redirect(array('action' => 'assignrights'));
                }
            }
            catch (Exception $e)
            {
                $this->Session->setFlash(__('Level Name already exist.'),'flash',array('alert'=>'danger'));
                return $this->redirect(array('action' => 'assignrights'));
            }
            $this->set('isError',true);
        }
    ...
    public function deletelevel()
    {
        ...
        if ($this->request->is('post'))
        {
            try
            {
                ...
                $this->Session->setFlash(__('Your Level user has been deleted.'),'flash',array('alert'=>'success'));
            }
            catch (Exception $e)
            {
                $this->Session->setFlash(__('Delete user first!'),'flash',array('alert'=>'danger'));
                return $this->redirect(array('action' => 'assignrights'));
            }
        }        
