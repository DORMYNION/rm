    ...
    public function add()
    {
        ...
        if ($this->request->is('post'))
        {
            ...
            try
            {
                ...
                {
                    $this->Session->setFlash(__('Extra payment has been saved.'),'flash',array('alert'=>'success'));
    ...
    public function deleteall()
    {
        try
        {
            if ($this->request->is('post'))
            {
                ...
                $this->Session->setFlash(__('Extra payment has been deleted.'),'flash',array('alert'=>'danger'));
            }        
