...
class ProjectsController extends AdminAppController {
    ...
    public function add()
    {
        ...
        $this->set('category',$this->Category->find('list',array('conditions'=>array('type'=>'PRJ','status'=>'Active'),'order'=>array('ordering'=>'asc'))));
        ...
        if ($this->request->is('post'))
        {
            ...
            try
            {
                if ($this->Project->save($this->request->data))
                {
                    ...
                    $this->Session->setFlash(__('Your Project has been saved.'),'flash',array('alert'=>'success'));
    ...
    public function deleteall()
    {
        try
        {
            if ($this->request->is('post'))
            {
                ...
                $this->Session->setFlash(__('Your Project has been deleted.'),'flash',array('alert'=>'success'));
            }        
