    ...
    public function add($clientId=null)
    {
        if ($this->request->is('post'))
        {
            ...
            try
            {
                ...
                {
                    $this->Session->setFlash(__('Your Coapplicant has been saved.'),'flash',array('alert'=>'success'));
    ...
    public function deleteall()
    {
        try
        {
            if ($this->request->is('post'))
            {
                ...
                $clientId=$this->data['clientId'];
                $this->Session->setFlash(__('Your Coapplicant has been deleted.'),'flash',array('alert'=>'success'));
            }        
