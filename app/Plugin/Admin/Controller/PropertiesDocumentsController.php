...
class PropertiesDocumentsController extends AdminAppController {
        ...
        if ($this->request->is('post'))
        {
            if ($this->request->is('post'))
            {
                ...
                try
                {
                    ...
                    $this->Session->setFlash(__('Document Photo has been saved'),'flash',array('alert'=>'success'));
    ...
    public function deleteall()
    {
        if ($this->request->is('post'))
        {
            ...
            $this->Session->setFlash(__('Your Document Photo has been deleted.'),'flash',array('alert'=>'success'));
            $propertyId=$this->data['propertyId'];
        }
