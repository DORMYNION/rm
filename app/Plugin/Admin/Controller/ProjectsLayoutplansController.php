...
class ProjectsLayoutplansController extends AdminAppController {
        ...
        if ($this->request->is('post'))
        {
            if ($this->request->is('post'))
            {
                ...
                try
                {
                    ...
                    $this->Session->setFlash(__('Layout Plan has been saved'),'flash',array('alert'=>'success'));
    ...
    public function deleteall()
    {
        if ($this->request->is('post'))
        {
            ...
            $this->Session->setFlash(__('Layout Plan has been deleted.'),'flash',array('alert'=>'success'));
            $projectId=$this->data['projectId'];
        }
