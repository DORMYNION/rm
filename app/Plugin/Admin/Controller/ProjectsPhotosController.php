...
class ProjectsPhotosController extends AdminAppController {
        ...
        if ($this->request->is('post'))
        {
            if ($this->request->is('post'))
            {
                ...
                try
                {
                    ...
                    $this->Session->setFlash(__('Project Photo has been saved'),'flash',array('alert'=>'success'));
    ...
    public function deleteall()
    {
        if ($this->request->is('post'))
        {
            ...
            $this->Session->setFlash(__('Your Project Photo has been deleted.'),'flash',array('alert'=>'success'));
            $projectId=$this->data['projectId'];
        }
