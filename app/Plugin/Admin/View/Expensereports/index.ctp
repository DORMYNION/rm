...
<div class="row">
    <div  class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Expense Report');?></span></h4>
			</div>
		</div>
		<div class="row mrg">
		    <?php if($dateBetween==false){?>
		    <div  class="col-sm-offset-2 col-md-3">
			<div><button class="btn btn-primary" type="button"><?php echo __('Total Expense Count this month');?>&nbsp;<span class="badge"><?php echo$this->Number->format($monthExpenseCount);?></span>
			<br/><br/><?php echo __('Total Expense this month');?>&nbsp;<span class="badge"><?php echo$currency.$this->Number->format($expenseMonth);?></span></button></div>
		    </div>
		    <?php }?>
		   <div  class="col-sm-offset-1 col-md-3">
			<div><button class="btn btn-primary" type="button"><?php if($dateBetween==false){ echo __('Total'); }?>&nbsp;<?php echo __('Expense Count');?>&nbsp;<span class="badge"><?php echo$totalExpenseCount;?></span>
			<br/><br/><?php if($dateBetween==false){?><?php echo __('Total');?><?php }?>&nbsp;<?php echo __('Expense');?>&nbsp;<span class="badge"><?php echo$currency.$this->Number->format($totalExpense);?></span></button></div>
		    </div>
		</div>
