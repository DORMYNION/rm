...
<table width="100%" class="table" style="max-height:960px;border-top: 0px">
    ...
    <tr>
        ...
        <td align="left" valign="top"><p><?php echo h($post['PropertiesFlat']['type']).' '.__('Number').': '.h($post['PropertiesFlat']['name']);?></p></td>
        <td align="left" valign="top"><p><?php echo __('Area').': '.h($post['PropertiesFlat']['area']).' '.h($post['Unit']['name']);?></p></td>
    </tr>
    <tr>
