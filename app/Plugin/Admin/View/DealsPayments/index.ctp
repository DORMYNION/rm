...
<?php echo $this->Html->css('print');?>
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Show Payments of').' '.$dealPayment[0]['Client']['name'].' '.__('for').' '.$dealPayment[0]['Property']['name'].' '.__('Total Amount').' '.$currency.$this->Number->format($dealPayment[0]['Deal']['total_amount']);?></span></h4>
			</div>
		</div>
			...
			?>
			    ...
			    <li><?php echo $this->Html->link('<span class="fa fa-print"></span>&nbsp;'.__('Print Receipt'),array('controller'=>'DealsPayments','action'=>'printreceipt',$id),array('target'=>'_blank','escape'=>false));?></li>
