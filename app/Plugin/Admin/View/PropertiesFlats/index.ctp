<div class="row">
    <div class="col-md-12">
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-arrow-left"></span>&nbsp;'.__('Back To Property'),array('controller' => 'Properties','action'=>'index'),array('escape' => false,'class'=>'btn btn-info'));?>
            <?php $url=$this->Html->url(array('controller'=>'PropertiesFlats')); echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Flat/Plot'),array('controller'=>'PropertiesFlats','action'=>'add',$propertyId),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<?php echo $this->Html->css('print');?>
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Flats/Plots');?></span></h4>
			</div>
		</div>
			    ...
			    <th><?php echo $this->Paginator->sort('PropertiesFlat.type', __('Type'), array('direction' => 'asc'));?></th>
			    <th><?php echo $this->Paginator->sort('Property.name', __('Property Name'), array('direction' => 'asc'));?></th>
                            <th><?php echo $this->Paginator->sort('name', __('Flat/Plot Name'), array('direction' => 'asc'));?></th>
			    <th><?php echo $this->Paginator->sort('floor_no', __('Floor/Plot No.'), array('direction' => 'asc'));?></th>
			    <th><?php echo $this->Paginator->sort('area', __('Area'), array('direction' => 'asc'));?></th>
			    <th><?php echo $this->Paginator->sort('price', __('Amount'), array('direction' => 'asc'));?></th>
