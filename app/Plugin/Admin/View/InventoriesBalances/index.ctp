...
<?php echo $this->Html->css('print');?>
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Show Entries of');?> <?php echo$expense['Vendor']['name'];?> <?php echo __('Invoice No');?>. <?php echo$expense['Inventory']['invoice_no'];?> <?php echo __('dated');?> <?php echo $this->Time->format($sysDay.$dateSep.$sysMonth.$dateSep.$sysYear,$expense['Inventory']['invoice_date']);?></span></h4>
			</div>
		</div>
