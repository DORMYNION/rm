...
<?php echo $this->Html->css('print');?>
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Show Payments of').' '.$expense['Vendor']['name'].' '.__('Invoice No').' '.$expense['Expense']['invoice_no'].' '.__('dated').' '.$this->Time->format($sysDay.$dateSep.$sysMonth.$dateSep.$sysYear,$expense['Expense']['invoice_date']);?></span></h4>
			</div>
		</div>
