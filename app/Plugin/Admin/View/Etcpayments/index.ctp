<div class="row">
    <div class="col-md-12">
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Extra Payment'),array('controller'=>'Etcpayments','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Extra Payments');?></span></h4>
			</div>
		</div>
			    ...
			    <th><?php echo $this->Paginator->sort('rate', __('Rate'), array('direction' => 'asc'));?></th>
