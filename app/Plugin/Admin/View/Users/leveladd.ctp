...
<?php echo $this->Session->flash();?>
    <div class="col-md-6 col-sm-offset-3">    
        <div class="panel panel-default mrg">
            <div class="panel-heading"><div class="widget-modal"><h4 class="widget-modal-title"><?php echo __('Add');?> <span><?php echo __('Level');?> <?php echo __('Users');?></span></strong></h4><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div></div>
                ...
                <?php echo $this->Form->create('User', array( 'controller' => 'User', 'action' => 'leveladd','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal'));?>
                    ...
                    <div class="form-group text-left">
                        <div class="col-sm-offset-3 col-sm-7">
                            ...
                            <?php if(!$isError){?><button type="button" class="btn btn-danger" data-dismiss="modal"><span class="fa fa-remove"></span> <?php echo __('Close');?></button><?php }?>
                        </div>
                    </div>
                </form>
                </div>
