<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            ...
            <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Assign Form Rights'),array('action'=>'assignrights'),array('escape'=>false,'class'=>'btn btn-success'));?>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Users');?></span></h4>
			</div>
		</div>
			    ...
			    <li><?php echo $this->Html->link('<span class="fa fa-edit"></span>&nbsp;'.__('Edit'),'#',array('name'=>'editallfrm','onclick'=>"check_perform_sedit('$url','$id');",'escape'=>false));?></li>
                            <li><?php if($id!=1){echo $this->Html->Link('<span class="fa fa-trash"></span>&nbsp;'.__('Delete'),'#',array('onclick'=>"check_perform_sdelete('$id');",'escape'=>false));}?></td></li>
			    </ul>
			  </div></td>
                        </tr>
                        <?php endforeach;?>
