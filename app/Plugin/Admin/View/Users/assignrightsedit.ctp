...
<?php echo $this->Form->create('User', array('controller' => 'PageRight','action'=>"assignrightsedit/$id",'name'=>'post_req','id'=>'post_req','class'=>'form-horizontal'));?>
    <div class="col-md-12">    
        ...
        <div class="panel-heading"><div class="widget-modal"><h4 class="widget-modal-title"><?php echo __('Assign');?> <span><?php echo __('Form Rights');?></span></strong></h4><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div></div>            
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <?php unset($post); ?>
                            <tr>
                                <td colspan="4"><button type="submit" class="btn btn-success"><span class="fa fa-refresh"></span> <?php echo __('Update');?></button></td>
                            </tr>
                            </table>
                    </div>
                </div>
