...
<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            <p><?php
            $url=$this->Html->url(array('controller'=>'Users','action'=>'assignrightsedit'));
            $url1=str_replace("/assignrights","",$this->Html->url(array('controller'=>'Users'))); echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Level'),'#',array('name'=>'add','id'=>'add','onclick'=>"check_perform_add('$url1/leveladd');",'escape'=>false,'class'=>'btn btn-success'));?>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"><?php echo __('Level');?> <span><?php echo __('Users');?></span></h4>
			</div>
		</div>
			...
			foreach ($Ugroup as $k=>$post):
			    ...
			    <td><?php echo h($post['Ugroup']['name']);?></td>
                            <td><?php echo $this->Html->link('<span class="fa fa-edit"></span>&nbsp;'.__('Set Permission'),'#',array('name'=>'editallfrm','onclick'=>"show_modal('$url/$id');",'escape'=>false,'class'=>'btn btn-warning'));?>
