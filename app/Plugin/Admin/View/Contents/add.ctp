...
<div class="col-md-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><?php echo __('Add Pages');?></div>
		...
		<label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Parent');?></small></label>
		<div class="col-sm-4">
		   <?php echo $this->Form->input('is_parent',array('type'=>'radio','options'=>array("Y"=>__("Yes"),"N"=>__("No")),'default'=>'N','legend'=>false,'before' => '<label class="radio-inline">','separator' => '</label><label class="radio-inline">','after'=>'</label>','label' => false,'div'=>false));?>
		</div>
		<label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Parent Id');?></small></label>
		<div class="col-sm-4">
		   <?php echo $this->Form->input('parent_id',array('type'=>'text','label' => false,'class'=>'form-control','placeholder'=>__('Top menu use 0 give Parent Id if sub menu'),'div'=>false));?>
		</div>
	    </div>
	    <div class="form-group">
