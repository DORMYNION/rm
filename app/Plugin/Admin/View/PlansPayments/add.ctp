...
<div class="col-md-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><?php echo __('Add Payments');?></div>
        ...
        if($recurring=='M')$dueDays=__('1 month');elseif($recurring=='Q')$dueDays=__('3 month');elseif($recurring=='Y')$dueDays=__('1 year');else$dueDays=null;
        ...
        <?php endfor;unset($k);?>
                ...
                <div class="col-sm-offset-3 col-sm-6">
                    ...
                    <?php echo$this->Html->link('<span class="fa fa-close"></span> '.__('Close'),array('controller'=>'PlansPayments','action'=>'index',$id),array('class'=>'btn btn-danger','escape'=>false));?>
            </div>
            </div>
