<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'PlansPayments')); if(!$Plan)echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;'.__('Add  Payments'),array('controller'=>'PlansPayments','action'=>'add',$id),array('escape'=>false,'escape'=>false,'class'=>'btn btn-success'));?>
	    ...
	    <?php echo $this->Html->link('<span class="glyphicon glyphicon-trash"></span>&nbsp;'.__('Delete'),'#',array('name'=>'deleteallfrm','id'=>'deleteallfrm','onclick'=>'check_perform_delete();','escape'=>false,'class'=>'btn btn-danger'));?>
            <?php echo $this->Html->link('<span class="glyphicon glyphicon-arrow-left"></span>&nbsp;'.__('Back To Deal'),array('controller' => 'Deals','action'=>'index'),array('escape' => false,'class'=>'btn btn-info'));?>
	</div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Plans Payments');?></span></h4>
			</div>
		</div>
