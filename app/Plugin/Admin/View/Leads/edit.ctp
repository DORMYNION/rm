...
<?php echo $this->Session->flash();?>
    <div class="col-md-12">    
        <div class="panel panel-default mrg">
            <div class="panel-heading"><div class="widget-modal"><h4 class="widget-modal-title"><?php echo __('Edit');?> <span><?php echo __('Leads');?></span></strong></h4><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div></div>
			...
			<div class="col-sm-4">
			   <?php echo $this->Form->input("$k.Lead.name",array('label' => false,'class'=>'form-control','placeholder'=>__('Name of Contact'),'div'=>false));?>
			</div>
			<label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Address');?>:</small></label>
			<div class="col-sm-4">
			   <?php echo $this->Form->input("$k.Lead.address",array('label' => false,'class'=>'form-control','placeholder'=>__('Address'),'div'=>false));?>
			</div>
		    </div>
            <div class="form-group">
                <label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Email');?>:</small></label>
                <div class="col-sm-4">
                   <?php echo $this->Form->input("$k.Lead.email",array('label' => false,'class'=>'form-control','placeholder'=>__('Email'),'div'=>false));?>
                </div>
                <label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Phone No.');?>:</small></label>
                <div class="col-sm-4">
                   <?php echo $this->Form->input("$k.Lead.phone",array('label' => false,'class'=>'form-control','placeholder'=>__('Phone No.'),'div'=>false));?>
                </div>
            </div>
                     <div class="form-group">
                        <label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Lead For');?>:</small></label>
                        <div class="col-sm-3">
                           <?php echo $this->Form->input("$k.Lead.typelead",array('type'=>'radio','options'=>array("Commercial"=>__("Commercial"),"Residential"=>__("Residential")),'legend'=>false,'before' => '<label class="radio-inline">','separator' => '</label><label class="radio-inline">','label' => false,'div'=>false));?>
                           </label>
                     </div>
		     <label for="group_name" class="col-sm-1 control-label"><small><?php echo __('Project');?>:</small></label>
                        <div class="col-sm-2">
                           <?php echo $this->Form->select("$k.Lead.project_id",$projectName,array('id'=>"projectId$id",'label' => false,'class'=>'form-control','empty'=>__('Please Select'),'div'=>false));?>
                           </label>
                        </div>
                     <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                           <?php echo $this->Form->input("$k.Lead.status",array('options'=>array('Awaiting/Closed'=>__('Awaiting/Closed'),'In Process'=>__('In Process'),'Cancelled'=>__('Cancelled'),'Site Visited'=>__('Site Visited'),'Document Collected'=>__('Document Collected')),'empty'=>__('Please Select'),'label' => false,'class'=>'form-control','div'=>false));?>
                        </div>                        
                    </div>            
