...
<?php echo $this->Html->css('print');?>
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Leads');?></span></h4>
			</div>
		</div>
			    ...
			    <th><?php echo $this->Paginator->sort('phone', __('Phone No.'), array('direction' => 'asc'));?></th>
			    <th><?php echo $this->Paginator->sort('Property.name', __('Property'), array('direction' => 'asc'));?></th>
			    <th><?php echo $this->Paginator->sort('Property.availiable', __('Availiable For'), array('direction' => 'asc'));?></th>
