...
<?php echo $this->Session->flash();?>
    <div class="col-md-12">    
        <div class="panel panel-default mrg">
            <div class="panel-heading"><div class="widget-modal"><h4 class="widget-modal-title"><?php echo __('Add');?> <span><?php echo __('Layout Plan');?></span></strong></h4><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div></div>
                ...
                <?php echo $this->Form->create('ProjectsLayoutplan', array( 'controller' => 'ProjectsLayoutplans', 'action' => 'add','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal','type' => 'file'));?>
                    <div class="form-group">
                        <label for="group_name" class="col-sm-4 control-label"><small><?php echo __('Add Image');?>:</small></label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group text-left">
                        <div class="col-sm-offset-4 col-sm-8">
                            ...
                            <button type="button" class="btn btn-danger" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> <?php echo __('Close');?></button>
