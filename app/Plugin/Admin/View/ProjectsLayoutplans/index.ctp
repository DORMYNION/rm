<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
	    <?php echo $this->Html->link('<span class="fa fa-arrow-left"></span>&nbsp;'.__('Back To Projects'),array('controller' => 'Projects','action'=>'index'),array('escape' => false,'class'=>'btn btn-info'));?>
            <?php $url=$this->Html->url(array('controller'=>'ProjectsLayoutplans')); echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Layout Plan'),'#',array('name'=>'add','id'=>'add','onclick'=>"check_perform_add('$url/add/$projectId');",'escape'=>false,'class'=>'btn btn-success'));?>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Layout Plan');?></span></h4>
			</div>
		</div>
			    ...
			    <td><?php echo $this->Html->image($post['ProjectsLayoutplan']['dir'].'_thumb/'.$post['ProjectsLayoutplan']['photo'],array('class'=>'img-thumbnail')); ?></td>
                            <td><?php echo $this->Html->link('<span class="glyphicon glyphicon-fullscreen"></span>&nbsp;'.__('View'),'#',array('onclick'=>"show_modal('$url/View/$id');",'escape'=>false,'class'=>'btn btn-primary'));?>
