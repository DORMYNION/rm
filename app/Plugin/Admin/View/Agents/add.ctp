<div class="col-md-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><?php echo __('Add Agents');?></div>
        ...
        <?php echo $this->Form->create('Agent', array( 'controller' => 'Agents', 'action' => 'add','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal'));?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                   <?php echo $this->Form->input('commission',array('label' => false,'class'=>'form-control','placeholder'=>__('Commission'),'div'=>false));?>
                </div>
            </div>
