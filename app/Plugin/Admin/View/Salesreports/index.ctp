...
<div class="row">
    <div  class="col-md-12">
		...
		<div class="row mrg">
			...
			<br/><br/><?php echo __('Total Earning this month');?> <span class="badge"><?php echo$currency.$this->Number->format($earningMonth);?></span></button></div>
		    </div>
		    <?php }?>
		   <div  class="col-sm-offset-1 col-md-3">
			...
			<br/><br/><?php if($dateBetween==false){?><?php echo __('Total');?><?php }?> <?php echo __('Earning');?> <span class="badge"><?php echo$currency.$this->Number->format($totalEearning);?></span></button></div>
		    </div>
		</div>
