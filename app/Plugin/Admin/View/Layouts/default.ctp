        		...
        		<ul class="dropdown-menu userinfo arrow">
        			<li class="username">
                        <a href="#">
        				    ...
        				    <div class="pull-right"><h5><?php echo $UserArr['User']['name'];?>!</h5><small><?php echo __('Logged in as');?> <span><?php echo $UserArr['User']['username'];?></span></small></div>
                        </a>
        			</li>
        			<li class="userlinks">
        				<ul class="dropdown-menu">
        					<li><?php echo $this->Html->link(__('My Profile').'&nbsp;<i class="pull-right fa fa-pencil"></i>',array('controller' => 'Users','action' => 'myProfile'),array('escape' => false));?></li>
						<li><?php echo $this->Html->link(__('Change Password').'&nbsp;<i class="pull-right fa fa-cog"></i>',array('controller' => 'Users','action' => 'changePass'),array('escape' => false));?></li>
						<li class="divider"></li>
						<li><?php echo $this->Html->link(__('Sign Out').'&nbsp;<i class="pull-right fa fa-power-off"></i>',array('controller' => 'Users','action' => 'logout'),array('escape' => false));?></li>						
        				</ul>
        			</li>
        		</ul>
        	</li>        	
    ...
    <footer role="contentinfo">
        <div class="clearfix">
            <ul class="list-unstyled list-inline pull-left">
                <li><span> <?php echo$siteName;?> &copy; <?php echo $this->Time->format('Y',$siteTimezone);?></span></li>		 
            </ul>
	    <button class="pull-right btn btn-inverse-alt btn-xs hidden-print" id="back-to-top"><i class="fa fa-arrow-up"></i></button>
	    <div class="pull-right"><?php echo __('Powered by');?> <?php echo$this->Html->Link(__('Silver Syclops'),'http://www.silversyclops.net',array('target'=>'_blank'));?></div>
        </div>
    </footer>
        <?php } else{?>
