...
<div class="row">
    <div  class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Profit & Loss Report');?></span></h4>
			</div>
		</div>
		<div class="row mrg">
		     <?php if($dateBetween==false){?>
		    <div  class="col-sm-offset-2 col-md-3">
			<div><button class="btn btn-primary" type="button"><?php echo __('Total Profit & Loss this month');?> <span class="badge"><?php echo$currency.$this->Number->format($profitMonth);?></span></button></div>
		    </div>
		    <?php }?>
		   <div  class="col-sm-offset-1 col-md-3">
			<div><button class="btn btn-primary" type="button"><?php if($dateBetween==false){?>Total<?php }?> <?php echo __('Profit & Loss');?> <span class="badge"><?php echo$currency.$this->Number->format($totalProfit);?></span></button></div>
		    </div>
		</div>
