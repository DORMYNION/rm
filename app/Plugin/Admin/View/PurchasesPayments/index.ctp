...
<?php echo $this->Html->css('print');?>
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Show Payments of');?> <?php echo$purchase['Purchase']['name'];?> <?php echo __('for');?> <?php echo$purchase['Purchase']['property_name'].' '.$purchase['Purchase']['area'];?></span></h4>
			</div>
		</div>
			...
			?>
			    ...
			    <li><?php echo $this->Html->Link('<span class="glyphicon glyphicon-trash"></span>&nbsp;'.__('Delete'),'#',array('onclick'=>"check_perform_sdelete('$id');",'escape'=>false));?></li>
			    </ul>
			  </div>
			    </td>                          
                        </tr>
