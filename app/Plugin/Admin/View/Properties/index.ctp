...
<div class="row">
    <div class="col-md-12 col-sm-offset-8">
        <div class="btn-group">
	    <?php echo$this->Html->link(__('View Availiable Only'),array('controller'=>'Properties','action'=>'index/skeyword:Availiable'),array('class'=>'btn btn-success'));?>
	    <?php echo$this->Html->link(__('View Sold Only'),array('controller'=>'Properties','action'=>'index/skeyword:Sold'),array('class'=>'btn btn-danger'));?>
	</div>
    </div>
</div>
...
<?php echo $this->Html->css('print');?>
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Properties');?></span></h4>
			</div>
		</div>
			    ...
			    <th><?php echo $this->Paginator->sort('Project.name', __('Project'), array('direction' => 'asc'));?></th>                            
			    <th><?php echo $this->Paginator->sort('type', __('Type'), array('direction' => 'asc'));?></th>
			    <th><?php echo $this->Paginator->sort('availiable', __('For'), array('direction' => 'asc'));?></th>
			    ...
			    <ul class="dropdown-menu" role="menu">
			      ...
			      <li><?php echo $this->Html->link('<span class="fa fa-building"></span>&nbsp;'.__('Flats/Plots'),array('controller'=>'properties_flats','action'=>"index/$id"),array('escape'=>false));?></li>
			      <li class="divider"></li>
