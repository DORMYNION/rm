<div class="row">
    <div class="col-md-12">
	    ...
	    echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Deal'),array('controller'=>'Deals','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<?php echo $this->Html->css('print');?>
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span><?php echo __('Deals');?></span></h4>
			</div>
		</div>
			    ...
			    <th><?php echo $this->Paginator->sort('Flat.name', __('Flat/Plot Name'), array('direction' => 'asc'));?></th>
