...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        callback({"id": <?php echo$clientArr['Client']['id'];?>, "text": "<?php echo$clientArr['Client']['name'];?>"});
        }
        });	
        $('#propertyId').select2({
...
<div class="col-md-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><?php echo __('Add Deal');?></div>
        ...
        <?php echo $this->Form->create('Deal', array( 'controller' => 'Deals', 'action' => 'add','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal'));?>
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10"><?php echo $this->Form->input('properties_flat_id',array('type'=>'text','id'=>'flatId','placeholder'=>__('Flat/Plot Name'),'label' => false,'class'=>'form-control','div'=>false));?>
                </div>                                     
            </div>
            <div class="form-group">
            ...
            <div class="form-group">                
                <label for="group_name" class="col-sm-2 control-label"><small><?php echo __('Payment Method').':';?></small></label>
                <div class="col-sm-2">
                ...
                <div class="col-sm-4">
                   <?php echo $this->Form->select('agent_id',$agent,array('label' => false,'class'=>'form-control','empty'=>__('Please Select'),'div'=>false));?>
                </div>
            </div>
            <div class="form-group">
